        ...
        <section className="w-screen flex flex-col items-center">
            <div className="w-full max-w-screen-xl px-4 flex items-center gap-2 justify-center">
                <button
                    ...
                    className="border w-7 h-7 flex justify-center items-center rounded-md border-white duration-300 hover:shadow-inner hover: hover:text-white hover:border-white hover:shadow-lime-700 hover:bg-lime-500">
